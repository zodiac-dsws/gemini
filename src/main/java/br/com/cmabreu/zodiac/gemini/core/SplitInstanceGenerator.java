...
public class SplitInstanceGenerator implements IInstanceGenerator {
	...
	public List<Instance> generateInstances(Activity activity, Fragment frag) throws Exception {
		...
		debug("'SPLIT' type detected: " + utes.size() + " instances will be created for activity " + activity.getTag());
